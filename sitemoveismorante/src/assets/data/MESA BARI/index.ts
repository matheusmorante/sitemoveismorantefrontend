import img1 from './images/MESA BARI - PRETA.jpg';
import img2 from './images/IMG_20230829_093758.jpg';
import img3 from './images/Bari_5134_preto cotada.jpg';

const mesaBari = {
    id:14,
    title: 'Mesa de Escritório Bari',
